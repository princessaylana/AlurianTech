...
public class CargoDroneSavePositionGoal
        extends MoveToTargetPosGoal {
    private final CargoDroneEntity mob;
    public CargoDroneSavePositionGoal(MobEntity mob, double speed, int range) {
    ...
    public boolean canStart() {
        ...
        if (!level.isDay() && !this.mob.isInLandingPose() && super.canStart()) {
            System.out.println("CDrone:Landing Mode");
    ...
    public void stop() {
        ...
        if (level.isDay() && this.mob.isInLandingPose()){
            ...
            System.out.println("CDrone:Stopped - Success");
    ...
    public void tick() {
        ...
        if (!level.isDay()) {
            if (!this.hasReached()) {
                System.out.println("CDrone:Flying to Alternate Landing Pos");
                //
                ...
                //
                System.out.println("CDrone: Alternate Landing Success");
            }
        }
    }
    @Override
    protected boolean isTargetPos(WorldView world, BlockPos pos) {
        ...
        BlockState blockState = world.getBlockState(pos);
         ...
         if(blockState.isOf(AlurianTechBlocks.DRONEBOX_BLOCK)){
    ...
    protected boolean scanForLandBlocks(WorldView world, BlockPos pos) {
        ...
        if(!blockState.isOf(Blocks.AIR)
            ...
            System.out.println("CDrone:Found Alternate Pos");
            return true;
        }
        return false;
    }
    public void tryToLand(BlockPos pos){
        ...
        if (aboveSurface) {
            ...
            if (this.mob.isOnGround() && level.isNight()){
                ...
                this.mob.setInLandingPose(false);
                System.out.println("CDrone:Stopping");
            }
        }
    }
