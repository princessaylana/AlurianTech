...
/**
 ...
 // A Api to help with placing nbt structures.
 // Made By : Emafire003
 // Repo: <a href="https://github.com/Emafire003/StructurePlacerAPI">...</a>
 // License: <a href="https://github.com/Emafire003/StructurePlacerAPI/blob/main/LICENSE">...</a>
 **/
...
public class StructurePlacerAPI {
    ...
    * @param integrity Set this to a value between 0f and 1f to remove some blocks from the placed structure. (All blocks = 1f)
    ...
    public boolean loadStructure() {
        System.out.println("StructureAPI:Loading Structure ...");
        if (this.templateName != null) {
            ...
            return optional.isPresent() && this.place((StructureTemplate) optional.get());
        } else {
            return false;
        }
    }
    ...
    public boolean place(StructureTemplate template) {
        System.out.println("StructureAPI:Placing Structure ...");
        try {
            ...
            System.out.println("StructureAPI:Error ...");
            e.printStackTrace();
            return false;
        }
    }
